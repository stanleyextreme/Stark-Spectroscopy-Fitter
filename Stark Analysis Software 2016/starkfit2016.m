...
%Gaussian parameters ----------------------------------------------------------------
    ...
    tblGauParms = uitable('Parent',pnlParam,'Position',[10 120 590 120],...
        ...
        'ColumnEditable',true(1,4),'Data',[ones(1,4)],... % was true(1,4) 1/31/16
        'CellEditCallback',{@connectGUI},'CellSelectionCallback',{@changeSel});
%Stark parameters -------------------------------------------------------------------
...
%Options ----------------------------------------------------------------------------
    ...
    tblOpts = uitable('Parent',pnlSettings,'Position',[10 150 182 130],...
        ...
        'ColumnWidth',{70},'Data',[],...% was Columnwidt 92
...
%% PLOTTING PANELS ==================================================================
axMain = axes('Parent',pnlPlotMain,'Position',[0.1,0.1,0.8,0.8],...
    'NextPlot','add','Box','on');
axStk = subplot(8,1,1:3,'parent',pnlPlotSide,...
    'NextPlot','add','Box','on','XTickLabel',[]);
axAbs = subplot(8,1,4:6,'parent',pnlPlotSide,...
    'NextPlot','add','Box','on');%,'XTickLabel',[]);
axRes = subplot(8,1,7:8,'parent',pnlPlotSide,...
    'NextPlot','add','Box','on');
